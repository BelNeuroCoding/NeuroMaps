...
keepChildren = [h.export_waterfall_button,h.startLabel_waterfall, ...
...
for i = startIdx:endIdx
    ...
    axWidth = max(panelPos(3)-sliderWidth, 1);  % must be >=1
    ...
    ax = axes('Parent',scrollPanel,...
              'Units','pixels',...
              'Position',[20 20 axWidth totalHeight]);
    
    
    slider = uicontrol('Parent',scrollPanel,...
        'Style','slider',...
        'Units','pixels',...
        'Position',[axWidth 0 sliderWidth panelPos(4)],...
        'Min',0,'Max',1,'Value',0,...
        'SliderStep',[0.02 0.1],...
        'Callback',@(src,~)scroll_waterfall(src,ax));
