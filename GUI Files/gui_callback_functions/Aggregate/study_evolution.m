...
%
% h: GUI handle containing cumulative spike data, burst params, etc.
...
%  Select metrics 
allMetrics = {'Spike Rate','FWHM','Peak-to-Peak Amplitude','Burst Rate','Synchrony', ...
    'Impedance','Capacitance','Aperiodic Offset','Aperiodic Exponent'};
[idx, tf] = listdlg('PromptString','Select metrics to plot:', ...
    'SelectionMode','multiple','ListString',allMetrics,'InitialValue',1:4);
if tf == 0, return; end
