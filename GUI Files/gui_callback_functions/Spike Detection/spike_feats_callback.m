...
for i = 1:size(selected,1)
    ...
    analysedset.num_activechans = numel(spike_rate_per_channel>0.0833); % Min. 5 spikes per minute
    ...
    analysedset.mean_spike_rate = nanmean(spike_rate_per_channel); 
    analysedset.std_spike_rate = nanstd(spike_rate_per_channel); 
