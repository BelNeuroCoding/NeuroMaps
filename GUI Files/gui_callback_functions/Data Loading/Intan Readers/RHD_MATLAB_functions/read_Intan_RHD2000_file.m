function [amplifier_data,amplifier_channels, t_amplifier] = read_Intan_RHD2000_file(file,path)
...
if (data_present)
    ...
    for i=1:num_data_blocks
        ...
        waitbar(i/num_data_blocks, wb, sprintf('Reading data... (%d%% done)', round(100*i/num_data_blocks)));
